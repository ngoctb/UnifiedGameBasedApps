...
public class ProjectPayment extends Applet implements Runnable {
  ...
  public void init()
  {
    ...
    controllerButton.add(new Label("Number Node Of Project:"));
  ...
  public void update()
  {
	  ...
	  g.drawString( "Activity List :" , 100 , 50 ) ;
  ...
  public void run() {
    ...
    while( countSame < 100 ) {
      ...
      this.setStatus( "Generation : " + generation + 
    		  		  " Fitness : " + currentFitness + 
    		  		  " Mutated : " + numberFormat.format( mutationRate ) + "%" + 
    		  		  " With net benefit for client : " + this.netBenefit + " million dollar " +
    		  		  " And money owner must paid is : " + costForOwner + " million dollar " ) ;
